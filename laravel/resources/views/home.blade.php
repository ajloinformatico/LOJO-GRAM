                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <p>{{$checkUserLike = DB::table('likes')->where('user_id', Auth::user()->id)->value('image_id')}}</p>
                                ...
                                @else <!--Dislike-->
                                    <p tyle="display: none;">{{$idLike = DB::table('likes')->where('user_id',Auth::user()->id)->where('image_id',$image['id'])->value('id')}}</p>
